...
**If you find my library useful, please buy me a beer!**
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_donations">
<input type="hidden" name="business" value="R77B7UXMLA6ML">
<input type="hidden" name="lc" value="US">
<input type="hidden" name="item_name" value="Beer For Jeff">
<input type="hidden" name="item_number" value="buyjeffsomebeer">
